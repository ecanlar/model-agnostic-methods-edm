...
- PDP temp and cnt: the hotter days, the more bikes are predicted to be rented. However, more bikes could be rented on average when the temperature is neither too cold nor too hot. 
...
- PDP windspeed and cnt: When the windspeed exceeds 24 km/h, approximately the number of bikes rented is noisily less. An interesting aspect is that when the windspeed is between 25km/h and 30km/h, there is no difference in the number of bikes rented, even it is higher. It could be that there is not much training data, and the Random Forest is not predicting well extreme (anomalous) values.
